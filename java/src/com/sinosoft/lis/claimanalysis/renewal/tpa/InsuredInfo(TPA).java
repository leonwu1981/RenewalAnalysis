...
public class InsuredInfo {
	...
	public static boolean outputInsuredInfoCsv( List list, String file_path, String file_name ){
	    ...
	    for(Iterator i = list.iterator(); i.hasNext(); ) {
	    	...
	    	strBuff.append(insuredInfo.getCustomerName());// 被保险人姓名
	    	strBuff.append(",");
...
//	    	str.append(this.format(insuredInfo.getGetDutyCode()));// 赔付责任
			...
			strBuff.append(",").append(insuredInfo.getTpaflag());
			strBuff.append(",").append(insuredInfo.getInnetwork());
	    	strBuff.append("\r\n");// 换行
	    }
...
//	    }
	...
	public Object clone(){
		InsuredInfo newInsuredInfo = new InsuredInfo();
		newInsuredInfo.setBranchCode(this.getBranchCode());
		newInsuredInfo.setGrpContNo(this.getGrpContNo());
		newInsuredInfo.setPolValiDate(this.getPolValiDate());
		newInsuredInfo.setPolEndDate(this.getPolEndDate());
		newInsuredInfo.setRepeatBill(this.getRepeatBill());
		newInsuredInfo.setAppntName(this.getAppntName());
		newInsuredInfo.setGrpNature(this.getGrpNature());
		newInsuredInfo.setBusinessType(this.getBusinessType());
		newInsuredInfo.setMainBussiness(this.getMainBussiness());
		newInsuredInfo.setCustomerNo(this.getCustomerNo());
		newInsuredInfo.setContno(this.getContno());
		newInsuredInfo.setCValiDate(this.getCValiDate());
		newInsuredInfo.setCEndDate(this.getCEndDate());
		newInsuredInfo.setOccupationType(this.getOccupationType());
		newInsuredInfo.setRetireFlag(this.getRetireFlag());
		newInsuredInfo.setRelationToMainInsured(this.getRelationToMainInsured());
		newInsuredInfo.setBirthday(this.getBirthday());
		newInsuredInfo.setSex(this.getSex());
		newInsuredInfo.setContPlanCode(this.getContPlanCode());
		newInsuredInfo.setContPlanName(this.getContPlanName());
		newInsuredInfo.setRiskCode(this.getRiskCode());
		newInsuredInfo.setDutyCode(this.getDutyCode());
		newInsuredInfo.setAmnt(this.getAmnt());
		newInsuredInfo.setPrem(this.getPrem());
		newInsuredInfo.setPayLine(this.getPayLine());
		newInsuredInfo.setDrugDailyLimit(this.getDrugDailyLimit());
		newInsuredInfo.setFeeDailyLimit(this.getFeeDailyLimit());
		newInsuredInfo.setBedDailyLimit(this.getBedDailyLimit());
		newInsuredInfo.setCheckDailyLimit(this.getCheckDailyLimit());
		newInsuredInfo.setPayRatio(this.getPayRatio());
		newInsuredInfo.setAccidentPayRatio(this.getAccidentPayRatio());
		newInsuredInfo.setExecuteCom(this.getExecuteCom());
		newInsuredInfo.setAge(this.getAge());
		newInsuredInfo.setAgeBand(this.getAgeBand());
		newInsuredInfo.setExposure(this.getExposure());
		newInsuredInfo.setExposure2(this.getExposure2());
		newInsuredInfo.setGetDutyCode(this.getGetDutyCode());
		newInsuredInfo.setExpenseAmnt(this.getExpenseAmnt());
		newInsuredInfo.setOwnExpenseAmnt(this.getOwnExpenseAmnt());
		newInsuredInfo.setPartExpenseAmnt(this.getPartExpenseAmnt());
		newInsuredInfo.setSsExpenseAmnt(this.getSsExpenseAmnt());
		newInsuredInfo.setRealPay(this.getRealPay());
		newInsuredInfo.setOpip(this.getOpip());
		newInsuredInfo.setVisitTimes(this.getVisitTimes());
		newInsuredInfo.setHospStayLength(this.getHospStayLength());
		newInsuredInfo.setAppntDept(this.getAppntDept());
		newInsuredInfo.setCustomerName(this.getCustomerName());
		newInsuredInfo.setPosFlag(this.getPosFlag());
		newInsuredInfo.setPayToDate(this.getPayToDate());
		newInsuredInfo.setBusinesstypein(this.getBusinesstypein());
		newInsuredInfo.setGebclient(this.getGebclient());
		newInsuredInfo.setDepartmentid(this.getDepartmentid());
		newInsuredInfo.setTpaflag(this.getTpaflag());
		newInsuredInfo.setInnetwork(this.getInnetwork());
