...
public class IbnrFactorCalculator2 {
	...
	IbnrFactorCalculator2(){
	}
	
	IbnrFactorCalculator2(String filePath, String jasperPath, String id, String dutyStr, int startYear, int startMonth, int endYear, int endMonth){
