...
public class CopyOfDataDownloadThread implements Runnable {
...
//	Hashtable lcHt = new Hashtable();
	...
	CopyOfDataDownloadThread() {
	} 
	CopyOfDataDownloadThread( int threadNum, String minContNo, String maxContNo, String path, String grpContNo, String startDate, String endDate, String manageCom, String riskCode, HashMap lmDutyGetRelaMap, String orgs ) {
...
//	        }
    ...
    public static void main(String[] args) {
    	String[] tPayRate = new CopyOfDataDownloadThread().getPayRate( "83000029500", "NIK12", "B", "602001", "602202", null, null );
