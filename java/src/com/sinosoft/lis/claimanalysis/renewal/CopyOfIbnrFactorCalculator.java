...
public class CopyOfIbnrFactorCalculator {
	...
	CopyOfIbnrFactorCalculator(){
	}
	
	CopyOfIbnrFactorCalculator(String filePath, String jasperPath, String id, String dutyStr, int startYear, int startMonth, int endYear, int endMonth){
		...
		System.out.println("mPeriod:" + mPeriod);
...
//				String ibnrType = this.getIbnrType(riskCode, getDutyCode);
		...
		FileProcessor.outputFile(buffer.toString(), file_path, "claim_factor_"+id+"_1", "csv");
...
//			type = "DD";
//		}  else if( "NMK01".equals(riskCode)){
//			type = "ADD";
//		}  else if( "NAK01".equals(riskCode) ){
//			type = "TL";
//		}  
		//»Ö¸´
