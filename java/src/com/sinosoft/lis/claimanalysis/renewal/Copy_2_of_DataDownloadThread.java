...
public class Copy_2_of_DataDownloadThread implements Runnable {
//外籍
...
//	Hashtable lcHt = new Hashtable();
	...
	Copy_2_of_DataDownloadThread() {
	} 
	Copy_2_of_DataDownloadThread( int threadNum, String minContNo, String maxContNo, String path, String grpContNo, String startDate, String endDate, String manageCom, String riskCode, HashMap lmDutyGetRelaMap, String orgs ) {
...
//				tmpDataTable = mDataAccess.executeDataTable(tmpSql);
			...
			do{
				...
				if( tContPlanName == null ){
					if(countStr(ssrs.GetText(a, 13),"外籍")!=0){
						continue;
					}
				} else {
					if(countStr(tContPlanName,"外籍")!=0){
						continue;
					}
				}
...
//	        }
    ...
    public static void main(String[] args) {
    	String[] tPayRate = new Copy_2_of_DataDownloadThread().getPayRate( "83000029500", "NIK12", "B", "602001", "602202", null, null );
