...
public class CircAutoImportBLS
{
    //传输数据类
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        System.out.println("Start CircAutoImportBLS Submit...");
        if (!this.saveData())
        {
            return false;
        }
        System.out.println("End CircAutoImportBLS Submit...");
    ...
    private boolean saveData()
    {
        ...
        if (conn == null)
        {
            ...
            tError.moduleName = "CircAutoImportBLS";
                    ...
                    for (int j = 0; j < set.size(); j++)
                    {
                        ...
                        if (className.endsWith("String"))
                        {
                            ...
                            if (!tExeSQL.execUpdateSQL(tSQL))
                            {
                                ...
                                tError.errorMessage = "执行更新SQL语句有误!";
                                this.mErrors.addOneError(tError);
                                conn.rollback();
                                conn.close();
                                return false;
