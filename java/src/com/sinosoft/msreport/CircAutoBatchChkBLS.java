...
public class CircAutoBatchChkBLS
{
    //传输数据类
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        System.out.println("Start CircAutoBatchChkBLS Submit...");
        if (!this.saveData())
        {
            return false;
        }
        System.out.println("End CircAutoBatchChkBLS Submit...");
