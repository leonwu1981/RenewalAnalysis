...
public class UWTakeBackAutoTransferAfterEndService implements AfterEndService
{
...
//    private boolean FirstTrialFlaog = false;
    ...
    public UWTakeBackAutoTransferAfterEndService()
    {
    }
    ...
    private boolean checkData()
    {
        ...
        tLWMissionDB.setActivityID("0000001029");
    ...
    private boolean prepareMission()
    {
        ...
        tSBql.append("' and ActivityID = '0000001027' and SubMissionID <> '");
        ...
        tSBql.append(mMissionID);
        tSBql.append("' and ActivityID = '0000001028' and MissionProp14 = '");
        tSBql.append(mLWMissionSchema.getMissionProp14());
        tSBql.append("' union Select * from LWMission where MissionID = '");
        tSBql.append(mMissionID);
        tSBql.append("' and ActivityID = '0000001029' and MissionProp14 = '");
        tSBql.append(mLWMissionSchema.getMissionProp14());
        tSBql.append("'");
        LWMissionDB tLWMissionDB = new LWMissionDB();
        ...
        tSBql.append(mMissionID);
        tSBql.append("' and ActivityID in ('0000001111','0000001112','0000001113','0000001106','0000001107','0000001108','0000001114','0000001115','0000001116','0000001017','0000001018','0000001019','0000001020','0000001021','0000001002','0000001027','0000001028','0000001029')");
