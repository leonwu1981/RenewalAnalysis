 ...
 * <p>Description: 新契约人工核保生调通知书回收AfterEnd服务类 </p>
...
public class TakeBackRReportAfterEndService implements AfterEndService
{
    ...
    private boolean checkData()
    {
        ...
        tLWMissionDB.setActivityID("0000001113");
    ...
    private boolean prepareMission()
    {
        ...
        tSBql.append("' and ActivityID = '0000001113' and SubMissionID <> '");
        ...
        tSBql.append(mMissionID);
        tSBql.append("' and ActivityID = '0000001116' and MissionProp14 = '");
        tSBql.append(mLWMissionSchema.getMissionProp14());
        tSBql.append("' union Select * from LWMission where MissionID = '");
        tSBql.append(mMissionID);
        tSBql.append("' and ActivityID = '0000001108' and MissionProp14 = '");
        tSBql.append(mLWMissionSchema.getMissionProp14());
        tSBql.append("'");
...
//                + mLWMissionSchema.getMissionProp14() + "'";
        ...
        tempLWMissionSet = tLWMissionDB.executeQuery(tSBql.toString());
        if (mLWMissionSet == null)
        {
            // @@错误处理
            //this.mErrors.copyAllErrors( tLCContDB.mErrors );
...
//判段该函件所在的状态 0000001113
        String tStr = "Select count(*) from LWMission where MissionID = '" +
            mMissionID + "' and ActivityID in ('0000001107','0000001108','0000001023','0000001017','0000001106','0000001112','0000001025','0000001019','0000001111')";
