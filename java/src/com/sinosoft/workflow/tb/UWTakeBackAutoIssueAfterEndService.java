...
//    private boolean FirstTrialFlaog = false;
    ...
    private boolean prepareMission()
    {
        ...
        tSBql.append("' and ActivityID = '0000001025' and SubMissionID <> '");
        ...
        tSBql.append(mMissionID);
        tSBql.append("' and ActivityID = '0000001024' and MissionProp14 = '");
        tSBql.append(mLWMissionSchema.getMissionProp14());
        tSBql.append("' union Select * from LWMission where MissionID = '");
        tSBql.append(mMissionID);
        tSBql.append("' and ActivityID = '0000001023' and MissionProp14 = '");
        tSBql.append(mLWMissionSchema.getMissionProp14());
        tSBql.append("'");
        LWMissionDB tLWMissionDB = new LWMissionDB();
        ...
        //判段该函件所在的状态 0000001025
        String tStr = "Select count(*) from LWMission where MissionID = '" +
            mMissionID + "' and ActivityID in ('0000001107','0000001108','0000001023','0000001017','0000001106','0000001112','0000001113','0000001019','0000001111')";
        ...
        if (tCount > 0) {
          tSBql.append(
              "update lwmission set activitystatus='2' where missionid='");
          tSBql.append(mMissionID);
          ...
          tSBql.append(
              "update lwmission set activitystatus='3' where missionid='");
          tSBql.append(mMissionID);
          tSBql.append("' and activityid='0000001100'");
          mUpWorkFlowSql = tSBql.toString();
        }
