...
/**
 * <p>Title: 工作流服务类:新契约补打生调通知书</p>
 * <p>Description: 补打生调通知书工作流AfterInit服务类</p>
...
public class RePrintRReportAfterInitService implements AfterInitService
{
    ...
    public RePrintRReportAfterInitService()
    {
    }
    ...
    private boolean checkData()
    {
        ...
        if (tLOPRTManagerSet == null)
        {
            ...
            tError.functionName = "checkData";
            tError.errorMessage = "生调通知书" + mLOPRTManagerSchema.getPrtSeq() +
                    "信息查询失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
        ...
        if (!mLOPRTManagerSchema.getCode().equals("04"))
        {
            CError tError = new CError();
            tError.moduleName = "RePrintAutoHealthAfterInitService";
            tError.functionName = "checkData";
