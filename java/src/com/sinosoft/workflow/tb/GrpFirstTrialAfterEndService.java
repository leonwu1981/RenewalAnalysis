...
public class GrpFirstTrialAfterEndService implements AfterEndService
{
...
//    private String mSubMissionID;
    ...
    public GrpFirstTrialAfterEndService()
    {
    }
    ...
    private boolean dealData()
    {
        ...
        String tSql = "select * from lwmission where missionid = '" + mMissionID + "' and activityid in ('0000002095')";
