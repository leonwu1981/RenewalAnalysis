...
/**
 * <p>Title: 工作流节点任务:新契约团单发核保通知书</p>
 * <p>Description: 发核保通知书工作流AfterInit服务类</p>
 * <p>Copyright: Copyright (c) 2004</p>
 * <p>Company: SinoSoft</p>
 * @author Yuanaq
 * @version 1.0--暂时只处理核保加费的信息
 */
...
*/
        ...
        if (flag == 0)
        {
            ...
            tError.errorMessage = "没有加费，不能发核保通知书!";
            this.mErrors.addOneError(tError);
            return false;
        }
        return true;
    ...
    private boolean getInputData(VData cInputData, String cOperate)
    {
        ...
        if(!tLCGrpContDB.getInfo())
        {
          ...
          tError.moduleName = "GrpUWSendNoticeAfterEndService";
          tError.functionName = "getInputData";
          tError.errorMessage = "没有查到相关集体合同!";
          this.mErrors.addOneError(tError);
          return false;
        }
        else
    ...
    private boolean preparePrt(String mContNo)
    {
       ...
       // if (mUWSendFlag.equals("1"))
        //{
            ...
            mLOPRTManagerSchema.setCode(PrintManagerBL.CODE_GRP_UW); //核保
            ...
            mLOPRTManagerSchema.setStandbyFlag1(mLCGrpContSchema.getAppntNo()); //投保人编码
