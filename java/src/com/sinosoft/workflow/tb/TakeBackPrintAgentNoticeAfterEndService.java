...
/**
 * <p>Title: 工作流节点任务:新契约人工核保回收业务员通知书 </p>
 * <p>Description:业务员体检通知书回收服务类 </p>
...
//                + "'and ActivityID = '0000001019' and SubMissionID <> '" + mSubMissionID
//                + "' and MissionProp14 = '" + mLWMissionSchema.getMissionProp14()
//                + "' union Select * from LWMission where MissionID = '" + mMissionID
//                + "' and ActivityID = '0000001017' and MissionProp14 = '"
//                + mLWMissionSchema.getMissionProp14()
//                + "' union Select * from LWMission where MissionID = '" + mMissionID
//                + "' and ActivityID = '0000001018' and MissionProp14 = '"
//                + mLWMissionSchema.getMissionProp14() + "'";
        StringBuffer tSBql = new StringBuffer(128);
        tSBql.append("Select * from LWMission where MissionID = '");
        tSBql.append(mMissionID);
        tSBql.append("'and ActivityID = '0000001019' and SubMissionID <> '");
        ...
        for (int i = 1; i <= mLWMissionSet.size(); i++)
        {
          ...
          //判段该函件所在的状态 0000001019
          String tStr = "Select count(*) from LWMission where MissionID = '" +
              mMissionID + "' and ActivityID in ('0000001107','0000001108','0000001023','0000001017','0000001106','0000001112','0000001113','0000001025','0000001111')";
