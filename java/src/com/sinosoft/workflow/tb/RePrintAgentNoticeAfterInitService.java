...
/**
 * <p>Title:工作流服务类:补打人工核保业务员通知书 </p>
 * <p>Description: 补打人工核保业务员通知书AfterInit服务类</p>
...
public class RePrintAgentNoticeAfterInitService implements AfterInitService
{
    ...
    public RePrintAgentNoticeAfterInitService()
    {
    }
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        System.out.println("After RePrintAgentNoticeAfterInitService");
    ...
    private boolean checkData()
    {
        ...
        if (!tLCContDB.getInfo())
        {
            ...
            tError.moduleName = "UWAgentAfterInitService";
        ...
        {
            CError tError = new CError();
            tError.moduleName = "RePrintAgentAfterInitService";
            tError.functionName = "checkData";
            tError.errorMessage = "业务员通知书" + mLOPRTManagerSchema.getPrtSeq() +
                    "信息查询失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
