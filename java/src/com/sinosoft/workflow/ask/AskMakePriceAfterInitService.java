...
public class AskMakePriceAfterInitService implements AfterInitService
{
    ...
    public AskMakePriceAfterInitService()
    {
    }
    /**
     * 传输数据的公共方法
    ...
    private boolean dealData() {
        ...
        //提交定价后将核保状态置为核保未回复
        mMissionSql = "update Lwmission set activitystatus = '2' where 1=1"
