...
public class AskSendInformationAfterInitService implements AfterInitService
{
    ...
    public AskSendInformationAfterInitService()
    {
    }
    ...
    private boolean checkData() {
        ...
        tLCGrpContDB.setGrpContNo(mLCInformationSet.get(1).getGrpContNo());
    ...
    private boolean getInputData(VData cInputData, String cOperate) {
      ...
      mTransferData = (TransferData) cInputData.getObjectByObjectName(
          "TransferData", 0);
    mLCInformationSet = (LCInformationSet)cInputData.getObjectByObjectName(
          "LCInformationSet", 0);
    ...
    private boolean dealData()
    {
        ...
        boolean tResult = tUWAskInfoBL.submitData(mInputData, "");
        if (tResult)
        {
            mMap = (MMap) tUWAskInfoBL.getResult().getObjectByObjectName("MMap",
                    0);
            mLOPRTManagerSchema = (LOPRTManagerSchema) tUWAskInfoBL.getResult().
