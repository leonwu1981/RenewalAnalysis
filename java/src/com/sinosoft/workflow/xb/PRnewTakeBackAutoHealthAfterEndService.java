...
public class PRnewTakeBackAutoHealthAfterEndService implements AfterEndService
{
    ...
    public PRnewTakeBackAutoHealthAfterEndService()
    {
    }
    ...
    private boolean checkData()
    {
        ...
        tLWMissionDB.setActivityID("0000000111");
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" + mMissionID + "'"
                ...
                + " and ActivityID = '0000000114'"
                + " and MissionProp3 = '" + mLWMissionSchema.getMissionProp14() + "'"
                + " union "
                + "Select * from LWMission where MissionID = '" + mMissionID + "'"
                + " and ActivityID = '0000000106'"
