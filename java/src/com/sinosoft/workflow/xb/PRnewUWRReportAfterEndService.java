...
public class PRnewUWRReportAfterEndService implements AfterEndService
{
    ...
    public PRnewUWRReportAfterEndService()
    {
    }
    ...
    private boolean getInputData(VData cInputData, String cOperate)
    {
        ...
        if (mGlobalInput == null)
        {
            ...
            tError.moduleName = "PRnewUWRReportAfterEndService";
