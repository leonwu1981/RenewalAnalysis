...
public class PRnewUWAddAfterEndService implements AfterEndService
{
    ...
    public PRnewUWAddAfterEndService()
    {
    }
    ...
    private boolean getInputData(VData cInputData, String cOperate)
    {
        ...
        if (mGlobalInput == null)
        {
            ...
            tError.moduleName = "PRnewUWAddAfterEndService";
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" + mMissionID + "'  "
                + "and ActivityID = '0000000100' and ProcessiD ='0000000001' ";
