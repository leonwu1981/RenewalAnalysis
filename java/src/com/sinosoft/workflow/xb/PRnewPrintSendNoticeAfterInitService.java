...
public class PRnewPrintSendNoticeAfterInitService implements AfterInitService
{
    ...
    public PRnewPrintSendNoticeAfterInitService()
    {
    }
...
//   }
    ...
    private boolean preparePrintSendNotice()
    {
        ...
        if (mPatchFlag == false) //不是补打，则更新数据状态
        {
            ...
            mLCUWMasterSchema.setPrintFlag("2"); //发送核保通知书
        }
    ...
    private boolean prepareTransferData()
    {
        ...
        mTransferData.setNameAndValue("Code", PrintManagerBL.CODE_PRnewUW);
