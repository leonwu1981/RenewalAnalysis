...
public class PRnewTakeBackSendNoticeAfterEndService implements AfterEndService
{
    ...
    public PRnewTakeBackSendNoticeAfterEndService()
    {
    }
    ...
    private boolean checkData()
    {
        ...
        tLWMissionDB.setActivityID("0000000112");
        ...
        if (tLWMissionSet == null || tLWMissionSet.size() != 1)
        {
            ...
            tError.moduleName = "PRnewPrintTakeBackSendNoticeAfterEndService";
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" + mMissionID + "'"
                ...
                + " and ActivityID = '0000000115'"
                + " and MissionProp3 = '" + mLWMissionSchema.getMissionProp14() + "'"
                + " union "
                + "Select * from LWMission where MissionID = '" + mMissionID + "'"
                + " and ActivityID = '0000000107'"
        ...
        if (mLWMissionSet == null)
        {
            ...
            //this.mErrors.copyAllErrors( tLCPolDB.mErrors );
            CError tError = new CError();
            tError.moduleName = "PRnewPrintTakeBackAutoHealthAfterEndService";
        ...
        //判段该核保通知书回收后,是否该保全申请已处于人工核保已回复状态.
