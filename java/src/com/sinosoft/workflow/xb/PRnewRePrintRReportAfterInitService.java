...
public class PRnewRePrintRReportAfterInitService implements AfterInitService
{
    ...
    public PRnewRePrintRReportAfterInitService()
    {
    }
    ...
    private boolean checkData()
    {
        ...
        if (tLOPRTManagerSet == null)
        {
            ...
            tError.functionName = "checkData";
            tError.errorMessage = "生调通知书" + mLOPRTManagerSchema.getPrtSeq() + "信息查询失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
        ...
        if (!mLOPRTManagerSchema.getCode().equals("44"))
        {
            CError tError = new CError();
            tError.moduleName = "PRnewRePrintAutoHealthAfterInitService";
            tError.functionName = "checkData";
            tError.errorMessage = "生调通知书" + mLOPRTManagerSchema.getPrtSeq() + "体检标识信息查询失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
                ...
                || !mLOPRTManagerSchema.getStateFlag().equals("1"))
        {
            ...
            tError.moduleName = "PRnewRePrintAutoHealthAfterInitService";
            tError.functionName = "checkData";
            tError.errorMessage = "生调通知书" + mLOPRTManagerSchema.getPrtSeq() + "标识未处于已打印,但未回收状态!";
            this.mErrors.addOneError(tError);
            return false;
        }
