...
/**
 * <p>Title: </p>
 * <p>Description:工作流节点任务:续保人工核保核保通知书回收服务类 </p>
...
public class PRnewTakeBackSendNoticeAfterInitService implements AfterInitService
{
    ...
    public PRnewTakeBackSendNoticeAfterInitService()
    {
    }
    ...
    private boolean checkData()
    {
        ...
        tLOPRTManagerDB.setCode(PrintManagerBL.CODE_PRnewUW); //
        ...
        for (int i = 1; i <= mLOPRTManagerSet.size(); i++)
        {
                    ...
                    && mLOPRTManagerSet.get(i).getStateFlag().trim().equals("1"))
            {
                ...
                tLZSysCertifyDB.setCertifyCode("6665"); //核保通知书标识
