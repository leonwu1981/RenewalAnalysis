...
public class PRnewRePrintSendNoticeAfterInitService implements AfterInitService
{
    ...
    public PRnewRePrintSendNoticeAfterInitService()
    {
    }
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        System.out.println("After PRnewRePrintSendNoticeAfterInitService");
    ...
    private boolean checkData()
    {
        ...
        if (tLOPRTManagerSet == null)
        {
            ...
            tError.functionName = "checkData";
            tError.errorMessage = "核保通知书" + mLOPRTManagerSchema.getPrtSeq() + "信息查询失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
        ...
        if (!mLOPRTManagerSchema.getCode().equals("45"))
        {
            ...
            tError.moduleName = "PEdorRePrintAutoHealthAfterInitService";
            tError.functionName = "checkData";
            tError.errorMessage = "核保通知书" + mLOPRTManagerSchema.getPrtSeq() + "体检标识信息查询失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
                ...
                || !mLOPRTManagerSchema.getStateFlag().equals("1"))
        {
            ...
            tError.moduleName = "PEdorRePrintAutoHealthAfterInitService";
            tError.functionName = "checkData";
            tError.errorMessage = "核保通知书" + mLOPRTManagerSchema.getPrtSeq() + "标识未处于已打印,但未回收状态!";
            this.mErrors.addOneError(tError);
            return false;
        }
