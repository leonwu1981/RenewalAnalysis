...
public class PRnewUWSendNoticeAfterInitService implements AfterInitService
{
    ...
    public PRnewUWSendNoticeAfterInitService()
    {
    }
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        System.out.println(" after PRnewUWSendNoticeAfterInitService.");
    ...
    private boolean prepareSendNotice()
    {
        ...
        mLCUWMasterSchema.setPrintFlag("1"); //发送核保通知书
    ...
    private boolean preparePrint()
    {
        ...
        mLOPRTManagerSchema.setCode(PrintManagerBL.CODE_PRnewUW); //核保通知书
        ...
        mLOPRTManagerSchema.setStandbyFlag3(mMissionID); //续保批单号
