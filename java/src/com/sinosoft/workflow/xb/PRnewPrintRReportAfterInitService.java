...
public class PRnewPrintRReportAfterInitService implements AfterInitService
{
...
//    private Reflections mReflections = new Reflections();
    ...
    public PRnewPrintRReportAfterInitService()
    {
    }
    ...
    private boolean checkData()
    {
        ...
        if (!tLCPolDB.getInfo())
        {
            ...
            tError.moduleName = "PRnewPrintSendNoticeAfterInitService";
        ...
        if (!tLCUWMasterDB.getInfo())
        {
            ...
            tError.moduleName = "PRnewPrintSendNoticeAfterInitService";
            tError.functionName = "checkData";
            tError.errorMessage = "保单" + mPolNo + "续保核保主表信息查询失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
    ...
    private boolean getInputData(VData cInputData, String cOperate)
    {
        ...
        if (mManageCom == null || mManageCom.trim().equals(""))
        {
            ...
            //this.mErrors.copyAllErrors( tLCPolDB.mErrors );
            CError tError = new CError();
            tError.moduleName = "PRnewUWSendNoticeAfterInitService";
            tError.functionName = "getInputData";
    ...
    private boolean preparePrintRReport()
    {
        ...
        if (!mPatchFlag) //不是补打，则更新数据状态
        {
            ...
            mLCUWMasterSchema.setReportFlag("2"); //打印面见通知书
        }
    ...
    private boolean prepareTransferData()
    {
        ...
        /** lisupdate 注释 **/
//	  tLCRReportDB.setSerialNo(tSerialNo);
//	  tLCRReportDB.setPolNo(mPolNo) ;
        ...
        /** lisupdate 注释 **/
//	  mTransferData.setNameAndValue("InsuredNo",tLCRReportSchema.getInsuredNo());
//	  mTransferData.setNameAndValue("InsuredName",tLCRReportSchema.getInsuredName()) ;
        ...
        /** lisupdate 注释 **/
//	  mTransferData.setNameAndValue("SerialNo",tLCRReportSchema.getSerialNo() ) ;
        ...
        mTransferData.setNameAndValue("Code", PrintManagerBL.CODE_PRnewMEET);
