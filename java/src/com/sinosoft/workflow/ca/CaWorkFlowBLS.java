...
public class CaWorkFlowBLS
{
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        System.out.println("Start CaWorkFlowBLS Submit...");
        if (!this.saveData())
            return false;
        System.out.println("End CaWorkFlowBLS Submit...");
    ...
    private boolean saveData()
    {
        ...
        if (conn == null)
        {
            ...
            tError.moduleName = "CaWorkFlowBLS";
