...
/**
 * <p>Title: </p>
 * <p>Description:工作流节点任务:保监会报表工作流XML汇总计算服务类 </p>
...
public class AllReportImportRedoAfterEndService implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public AllReportImportRedoAfterEndService()
    {
    }
...
//        mInputData = cInputData;
        if (mGlobalInput == null)
        {
            ...
            tError.moduleName = "AllReportImportRedoAfterEndService";
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID + "' and ActivityID in('0000000223','0000000224','0000000225','0000000227','0000000290','0000000291','0000000299')";
