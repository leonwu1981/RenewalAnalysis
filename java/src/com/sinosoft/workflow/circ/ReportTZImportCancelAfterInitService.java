...
public class ReportTZImportCancelAfterInitService implements AfterInitService
{
...
//    private LPPENoticeSchema mLPPENoticeSchema = new LPPENoticeSchema();
    public ReportTZImportCancelAfterInitService()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean dealData()
    {
        ...
        String tString = "delete from LFTZXml where StatYear=" + mStatYear.trim() +
