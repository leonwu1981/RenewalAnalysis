...
public class ReportCWImportSureAfterEndService implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public ReportCWImportSureAfterEndService()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID + "' and ActivityID in( '0000000206','0000000228','0000000229','0000000230','0000000231','0000000232','0000000233','0000000234')";
