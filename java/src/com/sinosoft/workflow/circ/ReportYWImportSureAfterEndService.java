...
public class ReportYWImportSureAfterEndService implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public ReportYWImportSureAfterEndService()
    {
    }
...
//        mInputData = cInputData;
        if (mGlobalInput == null)
        {
            ...
            tError.moduleName = "ReportYWImportSureAfterEndService";
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID + "' and ActivityID in('0000000203','0000000228','0000000229','0000000230','0000000231','0000000232','0000000233','0000000234')";
        ...
        if (mLWMissionSet == null)
        {
            ...
            tError.errorMessage = "查询保监会报表工作流业务数据确认任务节点失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
