...
public class ReportFBImportRedoAfterInitService implements AfterInitService
{
...
//    private Reflections mReflections = new Reflections();
    ...
    public ReportFBImportRedoAfterInitService()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean dealData()
    {
      ...
      mDeleteMidSQL = "delete from LFReinsureXml where StatYear=" + mStatYear +
