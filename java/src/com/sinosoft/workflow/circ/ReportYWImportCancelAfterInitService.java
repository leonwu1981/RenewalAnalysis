...
public class ReportYWImportCancelAfterInitService implements AfterInitService
{
...
//    private Reflections mReflections = new Reflections();
    public ReportYWImportCancelAfterInitService()
    {
    }
...
//        mOperate = cOperate;
    ...
    {
        mDeleteRiskGetSQL =
                "delete from LFRiskGet where year(reportdate)=" +
                mStatYear + " and month(reportdate)=" + mStatMon;
        mDeleteRiskAppSubSQL =
                "delete from  LFRiskAppSub where year(reportdate)=" +
                mStatYear + " and month(reportdate)=" + mStatMon;
        mDeleteRiskAppSQL =
                "delete from LFRiskApp where year(reportdate)=" +
                mStatYear + " and month(reportdate)=" + mStatMon;
        mDeleteProductSQL =
                "delete from lfproductxml where year(reportdate)=" +
                mStatYear + " and month(reportdate)=" + mStatMon;
        return true;
    }
