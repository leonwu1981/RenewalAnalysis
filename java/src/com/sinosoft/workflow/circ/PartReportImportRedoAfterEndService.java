...
public class PartReportImportRedoAfterEndService implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public PartReportImportRedoAfterEndService()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID + "' and ActivityID in('0000000223','0000000224','0000000225','0000000226','0000000290','0000000291','0000000299')";
