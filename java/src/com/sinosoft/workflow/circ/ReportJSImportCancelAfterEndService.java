...
public class ReportJSImportCancelAfterEndService implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public ReportJSImportCancelAfterEndService()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID + "' and ActivityID = '0000000214'";
