...
public class ReportYWImportCancelAfterEndService implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public ReportYWImportCancelAfterEndService()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID + "' and ActivityID = '0000000202'";
