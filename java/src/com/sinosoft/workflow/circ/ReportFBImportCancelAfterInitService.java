...
public class ReportFBImportCancelAfterInitService implements AfterInitService
{
...
//    private Reflections mReflections = new Reflections();
    ...
    public ReportFBImportCancelAfterInitService()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean dealData()
    {
      ...
      String tString = "delete from  LFReinsureXml where StatYear=" + mStatYear +
