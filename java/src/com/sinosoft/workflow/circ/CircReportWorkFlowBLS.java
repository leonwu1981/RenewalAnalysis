...
public class CircReportWorkFlowBLS
{
    //传输数据类
...
//        System.out.println("Start CircReportWorkFlowBLS Submit...");
        if (!this.saveData())
        {
            return false;
        }
//        System.out.println("End CircReportWorkFlowBLS Submit...");
...
//        System.out.println("---Start Save---");
        ...
        if (conn == null)
        {
            ...
            tError.moduleName = "CircReportWorkFlowBLS";
                ...
                if (map != null && map.keySet().size() != 0)
                {
                    ...
                    for (int j = 0; j < set.size(); j++)
                    {
                        ...
                        if (className.endsWith("String"))
                        {
                            ...
                            if (tSQL.compareTo("0") == 0)
                            {
                                System.out.println("hdaldfsalkfjlkasfj");
                            }
                            if (tSQL.trim().compareTo("0") == 0)
                            {
                                System.out.println("hdaldfsalkfjlkasfj");
                            }
                            if (tSQL.trim().compareTo("") == 0)
                            {
                                System.out.println("hdaldfsalkfjlkasfj");
                            }
