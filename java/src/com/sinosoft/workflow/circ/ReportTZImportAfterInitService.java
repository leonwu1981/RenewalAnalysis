 ...
 * @version 1.0
 */
public class ReportTZImportAfterInitService implements AfterInitService
{
//  @Fields
...
//    private int nCol;
    ...
    //     @Constructors
    public ReportTZImportAfterInitService()
    {
//    bulidDocument();
    }

    public ReportTZImportAfterInitService(String tFileName,
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        try
        {
            ...
            System.out.println("ReportJSImportAfterInitService生成Xml成功:" +
...
//	// 生成的目标XML数据到目标数据库表中
        ...
        else
        {
                ...
                tCircParserXml.getResult().size() > 0)
            {
                ...
                mResult = tCircParserXml.getResult();
                System.out.println("in ReportJSImportAfterInitService");
            }
        }
