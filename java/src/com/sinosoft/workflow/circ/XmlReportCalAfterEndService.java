...
public class XmlReportCalAfterEndService implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public XmlReportCalAfterEndService()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID +
                      "' and ActivityID in('0000000223','0000000226','0000000227')";
