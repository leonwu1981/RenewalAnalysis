...
/**
 * <p>Title: </p>
 * <p>Description:工作流节点任务:保监会报表工作流XML汇总计算撤销服务类 </p>
...
public class AllReportSureEndInitService implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public AllReportSureEndInitService()
    {
    }
...
//        mInputData = cInputData;
        if (mGlobalInput == null)
        {
            ...
            tError.moduleName = "AllReportSureEndInitService";
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID +
                      "' and ActivityID in('0000000226','0000000227','0000000291')";
        ...
        if (mLWMissionSet == null)
        {
            ...
            tError.errorMessage = "查询工作流的任务节点失败!";
            this.mErrors.addOneError(tError);
            return false;
        }
