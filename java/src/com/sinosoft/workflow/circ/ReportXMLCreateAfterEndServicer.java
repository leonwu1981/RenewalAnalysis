...
public class ReportXMLCreateAfterEndServicer implements AfterEndService
{
...
//    private String mDeleteSQL;
    ...
    public ReportXMLCreateAfterEndServicer()
    {
    }
...
//        mOperate = cOperate;
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" +
                      mMissionID +
                      "' and ActivityID in('0000000225','0000000226','0000000227')";
