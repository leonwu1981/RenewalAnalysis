...
public class ReportCWImportRedoAfterInitService implements AfterInitService
{
...
//    private Reflections mReflections = new Reflections();
    ...
    public ReportCWImportRedoAfterInitService()
    {
    }
...
//        mOperate = cOperate;
    ...
    {
        mDeleteMidSQL = "delete from LFFinXml where year(reportdate)=" +
                        mStatYear + " and month(reportdate)=" + mStatMon;
        mDeleteXMLSQL = "delete from LFXMLColl where StatYear=" +
                        mStatYear.trim() + " and StatMon=" + mStatMon.trim();
        return true;
    }
