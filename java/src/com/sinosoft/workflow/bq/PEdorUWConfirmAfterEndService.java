...
public class PEdorUWConfirmAfterEndService implements AfterEndService
{
    ...
    public PEdorUWConfirmAfterEndService()
    {
    }
    ...
    private boolean getInputData(VData cInputData, String cOperate)
    {
        ...
        tLPUWMasterMainSchema = (LPUWMasterMainSchema) mTransferData.getValueByName(
        ...
        if (tLPUWMasterMainSchema.getPassFlag() == null
                || tLPUWMasterMainSchema.getPassFlag().trim().equals(""))
        {
            // @@错误处理
            //this.mErrors.copyAllErrors( tLCPolDB.mErrors );
            CError tError = new CError();
    ...
    private boolean prepareMission()
    {
        ...
        //下保全核保最终结论
        if (mUWState.equals("1") || mUWState.equals("9") || mUWState.equals("8")
            ||mUWState.equals("4")||mUWState.equals("E")
            ||mUWState.equals("L")||mUWState.equals("a"))
        {
            mInitLWMissionSchema = null;

            LWMissionDB tLWMissionDB = new LWMissionDB();
            String tStr = "Select * from LWMission where MissionID = '" + mMissionID
                    + "' and ActivityID <> '0000000010'";
