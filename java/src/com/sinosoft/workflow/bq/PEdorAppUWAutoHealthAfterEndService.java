...
public class PEdorAppUWAutoHealthAfterEndService implements AfterEndService{
  ...
  public PEdorAppUWAutoHealthAfterEndService() {
  }
...
//
	//获得当前工作任务的任务ID
	  mMissionID = (String)mTransferData.getValueByName("MissionID");
         System.out.println("class信息：PEdorAppUWAutoHealthAfterEndService --->mMissionID="+mMissionID);
	   if ( mMissionID == null  )
	  {
		// @@错误处理
		//this.mErrors.copyAllErrors( tLCPolDB.mErrors );
	 ...
	 //获得当前工作任务的任务ID
	  mSubMissionID = (String)mTransferData.getValueByName("SubMissionID");
         System.out.println("class信息：PEdorAppUWAutoHealthAfterEndService --->mSubMissionID="+mSubMissionID);
	   if ( mMissionID == null  )
	  {
		// @@错误处理
		//this.mErrors.copyAllErrors( tLCPolDB.mErrors );
