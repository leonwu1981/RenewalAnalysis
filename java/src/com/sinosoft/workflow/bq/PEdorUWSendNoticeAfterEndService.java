...
public class PEdorUWSendNoticeAfterEndService implements AfterEndService
{
    ...
    public PEdorUWSendNoticeAfterEndService()
    {
    }
    ...
    private boolean getInputData(VData cInputData, String cOperate)
    {
        ...
        if (mGlobalInput == null)
        {
            ...
            tError.moduleName = "PEdorUWSendNoticeAfterEndService";
...
//                + "and ActivityID in( '0000000002','0000000003')";
...
//            tError.moduleName = "PEdorUWSendNoticeAfterEndService";
//            tError.functionName = "prepareMission";
//            tError.errorMessage = "查询工作流保全人工核保的加费和特约任务节点失败!";
//            this.mErrors.addOneError(tError);
//            return false;
//        }
//
