    ...
    private boolean preparePrintAutoHealth()
    {
        ...
        if (mLOPRTManagerSchema.getPatchFlag() == null)
          ...
          //不是补打，则更新数据状态
            ...
            mLPAppUWMasterMainSchema.setHealthFlag("2"); //已打印体检通知书标识
            ...
            tLPAppPENoticeDB.setCustomerNo(mLOPRTManagerSchema.getStandbyFlag1()); //备用字段1存放客户号
