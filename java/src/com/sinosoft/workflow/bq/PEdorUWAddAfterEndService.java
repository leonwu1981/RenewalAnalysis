...
public class PEdorUWAddAfterEndService implements AfterEndService
{
    ...
    public PEdorUWAddAfterEndService()
    {
    }
    ...
    private boolean getInputData(VData cInputData, String cOperate)
    {
        ...
        if (mGlobalInput == null)
        {
            ...
            tError.moduleName = "PEdorUWAddAfterEndService";
    ...
    private boolean prepareMission()
    {
        ...
        String tStr = "Select * from LWMission where MissionID = '" + mMissionID + "'  "
                + "and ActivityID = '0000000000' and ProcessiD ='0000000000' ";
