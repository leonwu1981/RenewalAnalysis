...
public class PEdorUWRReportAfterEndService implements AfterEndService
{
    ...
    public PEdorUWRReportAfterEndService()
    {
    }
    ...
    private boolean getInputData(VData cInputData, String cOperate)
    {
        ...
        if (mGlobalInput == null)
        {
            ...
            tError.moduleName = "PEdorUWRReportAfterEndService";
