...
public class PEdorRePrintRReportAfterInitService implements AfterInitService {
  ...
  /** 错误处理类，每个需要错误处理的类中都放置该类 */
	...
	public PEdorRePrintRReportAfterInitService() {
  }
  ...
  private boolean checkData()
  {
	...
	if(tLOPRTManagerSet.size() != 1)
	{
	 ...
	 if(!mLOPRTManagerSchema.getCode().equals("24"))
	 {
	  CError tError = new CError();
	  tError.moduleName = "PEdorRePrintAutoHealthAfterInitService";
	  tError.functionName = "checkData";
