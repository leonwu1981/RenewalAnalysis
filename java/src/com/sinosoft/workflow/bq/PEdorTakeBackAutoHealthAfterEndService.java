...
public class PEdorTakeBackAutoHealthAfterEndService implements AfterEndService
{
    ...
    public PEdorTakeBackAutoHealthAfterEndService()
    {
    }
    ...
    private boolean checkData()
    {
        ...
        tLWMissionDB.setActivityID("0000000011");
