...
public class PEdorPrintSendNoticeAfterInitService implements AfterInitService
{
...
//    private Reflections mReflections = new Reflections();
    ...
    public PEdorPrintSendNoticeAfterInitService()
    {
    }
...
//   }
    ...
    private boolean preparePrintSendNotice()
    {
        ...
        if (!mPatchFlag) //不是补打，则更新数据状态
        {
            ...
            mLPUWMasterMainSchema.setPrintFlag("2"); //发送核保通知书
        }
