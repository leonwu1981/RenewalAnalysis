...
//	   tError.moduleName = "PEdorUWSendNoticeAfterInitService";
//	   tError.functionName = "checkData";
//	   tError.errorMessage = "无核保通知书内容,发核保通知书失败!";
//	   this.mErrors .addOneError(tError) ;
//	   return false;
//	 }
//
...
//	   tError.moduleName = "PEdorUWSendNoticeAfterInitService";
//	   tError.functionName = "checkData";
//	   tError.errorMessage = "已经发核保通知书,还未打印,不可再次发核保通知书!";
//	   this.mErrors .addOneError(tError) ;
//	   return false;
//	 }
    ...
    private boolean prepareSendNotice()
    {
        ...
        mLPUWMasterMainSchema.setPrintFlag("1"); //发送核保通知书
    ...
    private boolean preparePrint()
    {
        ...
        mLOPRTManagerSchema.setCode(PrintManagerBL.CODE_PEdorUW); //核保通知书
        ...
        mLOPRTManagerSchema.setStandbyFlag3(mMissionID); //保全批单号
